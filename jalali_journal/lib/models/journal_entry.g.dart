...
extension JournalEntryByIndex on IsarCollection<JournalEntry> {
  Future<JournalEntry?> getByDay(DateTime day) {
    return getByIndex(r'day', [day]);
  }

  JournalEntry? getByDaySync(DateTime day) {
  ...
  Future<List<JournalEntry?>> getAllByDay(List<DateTime> dayValues) {
    final values = dayValues.map((e) => [e]).toList();
    return getAllByIndex(r'day', values);
  }

  List<JournalEntry?> getAllByDaySync(List<DateTime> dayValues) {
    final values = dayValues.map((e) => [e]).toList();
  ...
  Future<Id> putByDay(JournalEntry object) {
    return putByIndex(r'day', object);
  }

  Id putByDaySync(JournalEntry object, {bool saveLinks = true}) {
    return putByIndexSync(r'day', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllByDay(List<JournalEntry> objects) {
    return putAllByIndex(r'day', objects);
  }

  List<Id> putAllByDaySync(List<JournalEntry> objects,
      {bool saveLinks = true}) {
...
extension JournalEntryQueryWhereSort
  ...
  QueryBuilder<JournalEntry, JournalEntry, QAfterWhere> anyDay() {
    return QueryBuilder.apply(this, (query) {
...
extension JournalEntryQueryWhere
  ...
  QueryBuilder<JournalEntry, JournalEntry, QAfterWhereClause> dayEqualTo(
      DateTime day) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<JournalEntry, JournalEntry, QAfterWhereClause> dayNotEqualTo(
      DateTime day) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
  ...
  QueryBuilder<JournalEntry, JournalEntry, QAfterWhereClause> dayGreaterThan(
    DateTime day, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<JournalEntry, JournalEntry, QAfterWhereClause> dayLessThan(
    DateTime day, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<JournalEntry, JournalEntry, QAfterWhereClause> dayBetween(
    DateTime lowerDay,
    DateTime upperDay, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension JournalEntryQueryFilter
  ...
  QueryBuilder<JournalEntry, JournalEntry, QAfterFilterCondition> dayEqualTo(
      DateTime value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'day',
  ...
  QueryBuilder<JournalEntry, JournalEntry, QAfterFilterCondition> dayLessThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<JournalEntry, JournalEntry, QAfterFilterCondition> dayBetween(
    DateTime lower,
    DateTime upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension JournalEntryQuerySortBy
  ...
  QueryBuilder<JournalEntry, JournalEntry, QAfterSortBy> sortByDay() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'day', Sort.asc);
    });
  }

  QueryBuilder<JournalEntry, JournalEntry, QAfterSortBy> sortByDayDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension JournalEntryQuerySortThenBy
  ...
  QueryBuilder<JournalEntry, JournalEntry, QAfterSortBy> thenByDay() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'day', Sort.asc);
    });
  }

  QueryBuilder<JournalEntry, JournalEntry, QAfterSortBy> thenByDayDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'day', Sort.desc);
    });
  }
...
extension JournalEntryQueryWhereDistinct
  ...
  QueryBuilder<JournalEntry, JournalEntry, QDistinct> distinctByDay() {
    return QueryBuilder.apply(this, (query) {
...
extension JournalEntryQueryProperty
  ...
  QueryBuilder<JournalEntry, DateTime, QQueryOperations> dayProperty() {
    return QueryBuilder.apply(this, (query) {
